...
const SecurityConstants = {
  ...
  allowedFields: {
    ...
    config: [
      ...
      'avisoEntregaTexto',
      'logoUrl','faviconUrl','whatsappFlutuante','whatsappMensagemFlutuante',
      ...
      'compartilhamentoTitulo','compartilhamentoDescricao','compartilhamentoImagemUrl',
    ...
    cupons: [
      'codigo','tipo','valor','ativo','validadeInicio','validadeFim',
      'limiteUso','limitePorCliente','subtotalMinimo','descontoMaximo',
      'regras','criadoEm','atualizadoEm'
    ],

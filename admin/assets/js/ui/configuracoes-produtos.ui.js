...
function setupEventListeners() {
  ...
  document.getElementById('btnAdicionarOpcaoTamanho')?.addEventListener('click', () => adicionarOpcaoTamanho());

  document.querySelectorAll('.js-close-modal-tipo').forEach((el) => {
    el.addEventListener('click', () => fecharModalTipo());
  });
  document.querySelectorAll('.js-close-modal-categoria').forEach((el) => {
    el.addEventListener('click', () => fecharModalCategoria());
  });
  document.querySelectorAll('.js-close-modal-marca').forEach((el) => {
    el.addEventListener('click', () => fecharModalMarca());
  });
